...
Project Structure
text index.html style.css app.js graph.js metrics.js render.js ui.js
...
Internet connection is required for the D3.js CDN.
Press ↺ LOB11 preset to load the example configuration.
Press ▶ COMPUTE to generate the graph.
Modify planets, transits, filters, and orb settings as desired, then recompute.
...
Credits
D3.js — Data-Driven Documents by Mike Bostock, released under the ISC license.
License
